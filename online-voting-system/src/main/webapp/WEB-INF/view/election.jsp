...
<title>Online Voting System - Create Election</title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="content-box-large box-with-header content-area">
							<div id="election-general">
								<div class="form-group">
									<label for="election-name" class="col-sm-3 control-label">Organization Name</label>
									<div class="col-sm-9">
										<input type="text" id="election_name"
											placeholder="Organization Name" class="form-control"
											autofocus="autofocus" /> <span class="help-block error"
											id="election_name_error"></span>
									</div>
								</div>
								<div class="form-group">
									<label for="number-of-position" class="col-sm-3 control-label">Number
										of Position</label>
									<div class="col-sm-9">
										<input type="number" id="num_of_position"
											placeholder="Number of Position" class="form-control"
											autofocus="autofocus" /> <span class="help-block error"
											id="num_of_position_error"></span>
									</div>
								</div>

								<div class="form-group">
									<div class="col-md-4" style="float: right;">
										<input type="button" id="election-crete" class="btn btn-info"
											value="Next" style="float: right;" />
									</div>
								</div>

								<input type="hidden" id="csrf_param"
									value="${_csrf.parameterName}" />
							</div>
							<div id="election-info-div"></div>
