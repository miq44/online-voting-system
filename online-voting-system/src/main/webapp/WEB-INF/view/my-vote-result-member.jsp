...
<link href="<c:url value="/resources/css/app/style.css"/>"
	...
	rel="stylesheet">
<link href="<c:url value="/resources/css/vendor/c3.css" />" rel="stylesheet">
</head>
...
<body>
				...
				<div class="sidebar content-box"
					...
					<ul class="nav">
						...
						<li class="current"><a href="${pageContext.request.contextPath }/my-vote/${token}"><i
								class="glyphicon glyphicon-home"></i> My Election Result</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="content-box-header">
							<div class="panel-title">Organization Name - <strong>${organizationName}</strong></div>
	...
	<script src="https://d3js.org/d3.v3.js"></script>
		<script src="<c:url value="/resources/js/vendor/c3.js" />"></script>
		<script src="<c:url value="/resources/js/app/view_result.js" />"></script>
</body>
</html>